 ...
 * Size custom
 */
add_image_size( 'size-image-category-feature', 370, 250, true );
add_image_size( 'size-image-slider', 1170, 470, true );
...
add_action('widgets_init', function () {
    ...
    register_sidebar([
        'name'          => __('Footer Top 1', 'sage'),
        'id'            => 'footer-top-1'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer Top 2', 'sage'),
        'id'            => 'footer-top-2'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer Main 1', 'sage'),
        'id'            => 'footer-main-1'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer Main 2', 'sage'),
        'id'            => 'footer-main-2'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer Main 3', 'sage'),
        'id'            => 'footer-main-3'
    ] + $config);
    register_sidebar([
        'name'          => __('Footer Main 4', 'sage'),
        'id'            => 'footer-main-4'
    ] + $config);
    register_sidebar([
